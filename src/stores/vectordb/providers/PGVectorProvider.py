...
from ..VectorDBEnums import (DistanceMethodEnum, PgVectorIndexTypeEnumss, PgVectorTableSchemeEnums,
...
class PGVectorProvider(VectorDBInterface):
    def __init__(self, db_client,default_vector_size: int  = 786 ,
                 distance_method: str = DistanceMethodEnum.COSINE.value, index_type: str = None):
    ...
    # collection in pgvector is table
